...
venue: "Liggins Institute, The University of Auckland"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "May 17-18, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2021-05-18        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Justin M. O’Sullivan" "Tayaza Fadason", "Tommi Vatanen", "William Schierding", "Brooke Wilson", "Evgeniia Golovina", "Sreemol Gokuladhas"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["helper one", "helper two"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["t.fadason@auckland.ac.nz"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
